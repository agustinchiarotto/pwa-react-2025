...
//useState para definir un estado interno del componente.
function App() {
...
//  const [nombre, setNombre] = useState("Agustin");
    ...
    const onClickGuardarAnimalHandler = () => {
        ...
        setAnimales([...animales, {nombre: nombreNuevoAnimal, peso: 0, edad: 0, color: 'Gris'}])
  ...
  return (
    <div className="container">
        ...
        {contador >= 10 ? <Titulo texto="Ganaste!"/> : <Titulo texto="Todavia no ganaste, segui participando!"/> }
      <Button
        texto="+"
        onClick={sumar}
      />
        ...
        <Button texto="Buscar" onClick={filtar} />

        <hr />

        {animales.map((animal)=> {
            return <TarjetaAnimal nombre={animal.nombre}
                                  color={animal.color}
                                  edad={animal.edad}
                                  peso={animal.peso}
            />
